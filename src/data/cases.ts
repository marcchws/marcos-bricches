...
export const cases: Case[] = [
  ...
  },
  {
    ...
    complexidade: 'avançado',
    categoria: 'FinTech',
    descricao: 'Dashboard financeiro com análise de investimentos, controle de gastos, metas financeiras e relatórios detalhados.',
    funcionalidades: [
    ...
    tempoDesenvolvimento: '2h-6h',
    tags: ['fintech', 'investments', 'analytics', 'finance'],
    destaque: false,
    cor_tema: 'from-teal-600 to-cyan-600',
    data_criacao: '2024-01-01'
  },
  {
    id: 'workflow-aprovacoes',
    titulo: 'Sistema de Aprovações',
    tipo: 'gerado',
    complexidade: 'medio',
    categoria: 'Workflow',
    descricao: 'Sistema para workflow de aprovações com múltiplos níveis, notificações automáticas e histórico de decisões.',
    funcionalidades: [
    ...
    tags: ['workflow', 'approvals', 'notifications', 'automation'],
    destaque: false,
